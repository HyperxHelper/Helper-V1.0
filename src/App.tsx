...
export default function App() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    // B. Normal User Flow (with deterministic database auth)
    try {
      let firebaseUid = "";
      ...
      // Fallback guest check if the auth server could not be reached
  ...
  return (
    ...
    {productMode ? (
      <Product onBackToHome={() => setProductMode(false)} />
    ) : (
    <div 
      dir={isRtl ? "rtl" : "ltr"}
